...
const Perks = ({ selected, onChange }) => {
	...
	return (
		<div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5">
			...
			<label className="inline-flex gap-2 border p-4 m-2 rounded-2xl cursor-pointer">
				<input type="checkbox" checked={selected.includes("Computer")} name="Computer" onChange={handleCheckBox} />
				<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="w-6 h-6">
			...
			<label className="inline-flex gap-2 border p-4 m-2 rounded-2xl cursor-pointer">
				<input type="checkbox" checked={selected.includes("Pets Allowed")} name="Pets Allowed" onChange={handleCheckBox} />
				<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="w-6 h-6">
			...
			<label className="inline-flex gap-2 border p-4 m-2 rounded-2xl cursor-pointer">
				<input type="checkbox" checked={selected.includes("Washer")} name="Washer" onChange={handleCheckBox} />
				<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="w-6 h-6">
			...
			<label className="inline-flex gap-2 border p-4 m-2 rounded-2xl cursor-pointer">
				<input type="checkbox" checked={selected.includes("Fire Alarm")} name="Fire Alarm" onChange={handleCheckBox} />
				<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="w-6 h-6">

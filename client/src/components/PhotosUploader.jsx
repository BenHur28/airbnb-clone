					...
					addedPhotos.map((link) => (
						<div className="h-32 flex relative" key={link}>
							...
							<button
								...
								className="text-white bg-black bg-opacity-50 rounded-xl cursor-pointer absolute bottom-1 right-1 py-2 px-3"
							>
							...
							<button
								...
								className="text-white bg-black bg-opacity-50 rounded-xl cursor-pointer absolute bottom-1 left-1 py-2 px-3"
							>
								{link === addedPhotos[0] && (

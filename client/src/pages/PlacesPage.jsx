				...
				<div>
					<form className="max-w-7xl mx-auto mt-12">
						...
						<div className="flex gap-2">
							<input className="w-full border my-2 py-2 px-3 rounded-2xl" type="text" placeholder={"Add using a link....jpg"} />
							<button className="bg-red-500 text-white px-4 rounded-2xl">Add&nbsp;photo</button>
						</div>
						<div className="grid grid-cols-3 md-grid-cols-4 lg:grid-cols-6 mt-2">
							<button className="flex gap-2 items-center justify-center border bg-transparent rounded-2xl p-8 text-2xl text-gray-500">
						...
						<textarea className="w-1/2 border my-2 py-2 px-3 rounded-2xl" rows="5"></textarea>
						<h2 className="text-xl mt-4">Perks</h2>
						<p className="text-gray-500 text-sm">Select all the perks of your place.</p>
						<div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5">
							<label className="inline-flex gap-2 border p-4 m-2 rounded-2xl cursor-pointer">
								<input type="checkbox" />
						...
						<p className="text-gray-500 text-sm">add check in and out times, remember to have time window for cleaning between guests</p>
						<div className="grid sm:grid-cols-3">
							<div>
								<h3>Check in time</h3>
								<input className="w-full border my-2 py-2 px-3 rounded-2xl" type="text" placeholder="14:00" />
							</div>
							<div>
								<h3>Check out time</h3>
								<input className="w-full border my-2 py-2 px-3 rounded-2xl" type="text" placeholder="10:00" />
							</div>
							<div>
								<h3>Max guests</h3>
								<input className="w-full border my-2 py-2 px-3 rounded-2xl" type="text" placeholder="8" />
							</div>
						</div>

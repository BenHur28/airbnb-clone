						...
						<div className="w-2/3 mx-auto mt-10">
							{booking.place.photos.length > 0 && (
								<Link to={`/account/bookings/${booking._id}`} className="flex gap-4 bg-gray-200 rounded-2xl overflow-hidden mb-4">
									<div className="w-48">
										<img className="object-cover aspect-square " src={"http://localhost:3000/uploads/" + booking.place.photos[0]} alt=""></img>
									</div>
									<div className="py-3 pr-3 grow">
										<h2 className="text-2xl">{booking.place.title}</h2>
										<div className="flex items-center border-t border-gray-300 mt-2 py-2 text-xl gap-2">
